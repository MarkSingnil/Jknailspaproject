    ...
    <div id="site-content">
        ...
        <div class="container">
          ...
          <div class="main-navigation">
            ...
            <ul class="menu">
              ...
              <li class="menu-item current-menu-item"><a href="job.html">Jobs</a></li>
      ...
      <main class="main-content">
        <div class="page">
          <div class="container">
              ...
              <h2 class="section-title">We're sorry, but there are some of your important information are missing</h2>
      ...
      <footer class="site-footer">
        <div class="container">
          ...
          <div class="colophon">
            <p>Copyright 2016 Jonathan Khoi. Designed by <a href="http://rocketsdesign.com">RocketsDesign</a>. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
